...
<head>
  ...
  <!-- Custom Css & Js -->
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/inputplaylist.css">
  <!-- Favicon -->
...
<body>
  ...
  <div class="container">
    ...
    <!-- Section : Inputplaylist -->
    <section class="inputplaylist" id="inputplaylist">
      <div class="section-inner">
      	<div class="inputplaylist-inner">
				<form action="${pageContext.request.contextPath}/AddPlaylist" method="post" class="CreateMylistForm inputplaylist-form" name="CreateMylistForm">
...
<%--          <label for="question">Enter your question:</label><br>--%>
  ...
  <script src="${pageContext.request.contextPath}/js/inputplaylist.js"></script>
